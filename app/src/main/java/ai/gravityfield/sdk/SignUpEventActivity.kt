...
import ai.gravityfield.gravity_sdk.models.SignUpEvent
...
class SignUpEventActivity : ComponentActivity() {
...
fun SignUpEventScreen() {
    ...
    Column(
        ...
        Text(
            text = "Sign Up Event Configuration",
