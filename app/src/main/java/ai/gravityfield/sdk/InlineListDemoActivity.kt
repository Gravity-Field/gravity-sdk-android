...
import ai.gravityfield.gravity_sdk.ui.GravityInlineListView
...
class InlineListDemoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_inline_list_demo)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        val recyclerView: RecyclerView = findViewById(R.id.recyclerView)
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.adapter = InlineListRecyclerAdapter(pageContext)
    }
...
private class InlineListRecyclerAdapter(
    val pageContext: PageContext,
        ...
        return when (viewType) {
            TYPE_INLINE -> {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.item_inline_list, parent, false)
                InlineViewHolder(view as GravityInlineListView)
            }
    ...
    inner class InlineViewHolder(val view: GravityInlineListView) : RecyclerView.ViewHolder(view) {
