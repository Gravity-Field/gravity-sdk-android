...
class AddToCartEventActivity : ComponentActivity() {
...
fun AddToCartEventScreen() {
    ...
    Column(
        ...
        Text(
            text = "Add To Cart Event Configuration",
            modifier = Modifier.padding(bottom = 24.dp)
        )

        // AddToCartEvent fields
        OutlinedTextField(
            value = value,
        ...
        ShowContentButton(
            onClick = {
                ...
                // Create AddToCartEvent with configured values
