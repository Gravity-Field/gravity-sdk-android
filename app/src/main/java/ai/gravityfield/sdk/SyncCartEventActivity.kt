...
import ai.gravityfield.gravity_sdk.models.SyncCartEvent
...
class SyncCartEventActivity : ComponentActivity() {
...
fun SyncCartEventScreen() {
    ...
    Column(
        ...
        Text(
            text = "Sync Cart Event Configuration",
        ...
        ShowContentButton(
            onClick = {
                ...
                val syncCartEvent = SyncCartEvent(
                    value = parsedValue,
